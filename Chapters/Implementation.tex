...
\begin{figure}
   \centering
   \includegraphics[width=3.5cm]{Figs/Single_couple.pdf} %2.5
...
\begin{figure}[h!]
\begin{tabular}{cc}
\subfloat[]{\includegraphics[width=6cm]{Plots/4096.pdf} \label{plot:bench-4096}} & 
\subfloat[]{\includegraphics[width=6cm]{Plots/8192.pdf} \label{plot:bench-8192}} \\
\multicolumn{2}{c}{
\subfloat[]{\includegraphics[width=6cm]{Plots/16384.pdf} \label{plot:bench-16384}} }
\end{tabular}
\caption{Execution time for linear system size: (a) 4096; (b) 8192; (c) 16384.} 
\end{figure}
%\end{center}
...
\begin{figure}[b]
   \centering
   \includegraphics[width=8cm]{Plots/4096.pdf}
