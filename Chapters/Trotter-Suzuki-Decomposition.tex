...
\end{matrix} \right),
\end{equation}
yields the monotonic energy increase shown in Fig.. The reason of the difference between the approximants must be keeping the symplecticity, or the conservation of the phase-space volume.
\begin{figure}[t]
\centering
\begin{tabular}{ccc}
